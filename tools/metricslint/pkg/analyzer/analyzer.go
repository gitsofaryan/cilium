...
func getEllipsisRHSExpansion(expr ast.Expr) (*ast.CompositeLit, error) {
	...
	if !ok {
		ast.Print(nil, inlineAssignment.Rhs[0])
...
func countArgs(call *ast.CallExpr) (int, error) {
	...
	// If you're debugging this, you might want to uncomment the following
	// line to get an understanding of the AST you're analyzing.
	//ast.Print(nil, call)
